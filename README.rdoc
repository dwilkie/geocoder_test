...
You must provide the rails-geocoder gem to each app. It is not included because it is assumed you are using this app to test changes to it. I suggest adding a symbolic link in vendor/plugins (in each app) to your geocoder source directory.
