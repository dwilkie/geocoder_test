...
The rails-geocoder gem is installed as a plugin in each app, and is checked out directly from the repository as a Git submodule. Be sure to check out submodules before running the tests:
